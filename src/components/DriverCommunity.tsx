...
const CommunityDetails: React.FC<CommunityDetailsProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gray-900 px-6 pt-10 pb-10">
      ...
      {/* Community Card */}
      <div className="bg-[#4D00FF] rounded-lg shadow-lg p-2 mt-6 mb-8 pb-6">
        ...
        <div className="relative">
          ...
          />
          <p className="text-stone-200 text-sm mx-4">{community.description}</p>
        </div>
      </div>
      ...
      <table className="min-w-full bg-gray-800 rounded-lg shadow mb-4">
        <thead>
